...
import com.feue.ml.activity.LoginActivity;
...
public final class TokenUtils {
    ...
    private static final String KEY_TOKEN = "com.feue.ml.utils.KEY_TOKEN";
    ...
    public static void clearToken() {
        ...
        MMKVUtils.remove("user_username");
        MMKVUtils.remove("user_type");
        MMKVUtils.remove("user_name");
        MMKVUtils.remove("user_clazz");
        MMKVUtils.remove("user_phone");
        MMKVUtils.remove("user_email");
    }
