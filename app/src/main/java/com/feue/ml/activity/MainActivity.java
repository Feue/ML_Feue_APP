...
import com.feue.ml.core.BaseActivity;
import com.feue.ml.core.BaseFragment;
import com.feue.ml.fragment.course.CourseManageFragment;
import com.feue.ml.fragment.course.SearchCourseFragment;
import com.feue.ml.fragment.learn.LearnFragment;
import com.feue.ml.fragment.news.NewsFragment;
import com.feue.ml.fragment.other.AboutFragment;
import com.feue.ml.fragment.notice.NoticeFragment;
import com.feue.ml.fragment.other.SettingsFragment;
import com.feue.ml.fragment.practice.PracticeFragment;
import com.feue.ml.fragment.profile.ProfileFragment;
import com.feue.ml.utils.MMKVUtils;
import com.feue.ml.utils.Utils;
import com.feue.ml.utils.XToastUtils;
import com.feue.ml.utils.sdkinit.XUpdateInit;
import com.feue.ml.widget.GuideTipsDialog;
import com.google.android.material.bottomnavigation.BottomNavigationView;
import com.feue.ml.R;
import com.feue.ml.databinding.ActivityMainBinding;
...
public class MainActivity extends BaseActivity<ActivityMainBinding> implements View.OnClickListener, BottomNavigationView.OnNavigationItemSelectedListener, ClickUtils.OnClick2ExitListener, Toolbar.OnMenuItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userType = String.valueOf(MMKVUtils.get("user_type", "0"));
...
//        mTitles = ResUtils.getStringArray(R.array.home_titles);
        mTitles = new String[] {"首页", userType.equals("0") ? "学习" : "课程", "我的"};
...
//        binding.includeMain.toolbar.setOnMenuItemClickListener(this);
        ...
        BaseFragment[] fragments = new BaseFragment[]{
                new NewsFragment(),
//                new LearnFragment(),
                userType.equals("0") ? new LearnFragment() : new CourseManageFragment(),
                new ProfileFragment()
        };
        binding.includeMain.bottomNavigation.getMenu().getItem(1).setTitle(mTitles[1]);
        binding.navView.getMenu().getItem(1).setTitle(mTitles[1]);
...
//            }
        ...
        String username = String.valueOf(MMKVUtils.get("user_username", this.getString(R.string.app_name)));
        ...
        binding.navView.setNavigationItemSelectedListener(menuItem -> {
            if (menuItem.isCheckable()) {
                ...
                if (id == R.id.nav_settings) {
                    ...
                    openNewPage(NoticeFragment.class);
                } else if (id == R.id.nav_practice) {
                    openNewPage(PracticeFragment.class);
                } else if (id == R.id.nav_search) {
                    openNewPage(SearchCourseFragment.class);
                } else {
